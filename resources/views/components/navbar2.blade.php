        ...
        <div class="flex items-center ml-4 gap-x-4 md:ml-6">
          ...
          <div x-data="{ isOpen: false }">
            <button @click="isOpen = !isOpen" size="md" color="secondary"
              class="flex items-center justify-center rounded-[8px] gap-2 px-10 py-2 text-base font-medium duration-300 border bg-customBlue-100 hover:bg-customBlue-200 text-sky-400 border-sky-400 focus:ring focus:ring-sky-200">
            ...
            <div x-show="isOpen" x-transition:enter="transition ease-out duration-200 transform"
              ...
              <div
                ...
                <x-button size="md" color="white" class="flex items-center w-full gap-2 mt-2"
                  ...
                  <p class="text-[13px] text-slate-950">Pengaturan Akun</p>
                </x-button>
                <x-button size="md" color="white" class="flex items-center w-full gap-2 mt-2">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
