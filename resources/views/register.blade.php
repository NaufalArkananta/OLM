            ...
            <div
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div>
                            <label for="number" class="block mb-2 text-xl font-normal text-gray-900">Nomor
                                Telephone</label>
                            <input type="number" name="number" id="number"
                                class="bg-gray-50 border border-slate-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 placeholder:text-slate-400 placeholder:font-normal"placeholder="Masukkan Nomor Telephone Anda"
                                required>
                        </div>
                        <div>
                        ...
                        <a href="#" class="text-xl font-normal text-sky-400 hover:underline mt-0.5">Lupa
                            password?</a>
