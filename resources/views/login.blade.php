          ...
          <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <button type="button" @click="isOpen = !isOpen" class="absolute flex items-center px-2 right-3">
              ...
              <a href="#" class="text-xl font-normal text-sky-400 hover:underline mt-0.5 mb-6">Lupa password?</a>
