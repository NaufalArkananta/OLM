<x-layout-container>
  ...
  <section class="px-6 pb-6 mx-auto mb-10 max-w-screen-2xl lg:px-8">
      ...
      <div x-data="{ open: null }" class="border-b divide-y divide-slate-300 border-slate-300">
        <div class="p-4">
          ...
          <div x-show="open === 4" x-transition
            ...
            <button
              class="p-2 text-center duration-300 border rounded-lg lg:px-10 bg-slate-200 hover:bg-sky-300 hover:text-white focus:bg-sky-400 focus:ring-2 focus:ring-sky-100 focus:text-white border-slate-300">Terbaru</button>
            <button
    ...
    <div class="mt-10">
      <div>
        <h4 class="text-4xl font-semibold text-slate-950">Rumah Dijual di Indonesia, Harga Rumah Terbaru 2024</h4>
