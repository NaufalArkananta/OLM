        ...
        <div class="flex flex-col gap-6">
            @foreach ($data_property as $property)
                <div x-data="{ isOn: false }"
                    ...
                    <div class="items-center flex flex-col justify-center border-l-2 border-slate-300 pl-4 ">
                        <h1 class="font-poppins text-3xl text-sky-600">Komisi Sales:</h1>
                        <h1 class="font-poppins text-5xl font-semibold text-sky-600">{{ $property['komisi'] }}</h1>
                        <h1 class="font-poppins text-3xl text-sky-600">Komisi Web:</h1>
                        <h1 class="font-poppins text-5xl font-semibold text-sky-600">{{ $property['komisi_web'] }}</h1>
                    </div>
                </div>
            @endforeach
        </div>
