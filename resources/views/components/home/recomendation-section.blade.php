<div class="w-full my-10 mt-28">
  <div class="flex justify-between w-full">
    <h4 class="text-2xl font-semibold md:text-3xl lg:text-5xl text-slate-900 text-start">Rekomendasi Properti dari Kami
    </h4>
    <x-button type="button" onclick="window.location.href = '/properti'" size="lg" color="primary" type="button"
      class="flex items-center justify-center my-2 gap-x-2 lg:my-0">
      <p>Lihat Lainya</p>
  ...
  <div class="overflow-x-scroll">
    <div class="flex gap-4 my-4 w-max flex-nowrap">
      <div x-data="{ isOn: false }" class="p-4 bg-frost-white rounded-[10px] border border-slate-300 mb-4 relative">
        <img src="{{ asset('img/villa-dummy.jpg') }}"
          class="object-cover w-[320px] h-[210px] rounded-[8px] border border-slate-300" alt="">
        <div class="rounded-[8px] bg-customBlue-250 px-3 py-2 my-3 w-fit">
          <p class="text-xl font-medium text-sky-400">Rumah</p>
        </div>
        <div class="text-start">
          <h5 class="my-2 text-5xl font-semibold text-sky-600">Rp 950.5 Juta</h5>
          <p class="text-3xl font-normal text-slate-400">Rumah mewah Gunung Buring</p>
          <p class="text-xl font-normal text-slate-400">Kota Malang, Malang Raya</p>
        </div>
          ...
          <svg x-show="isOn" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <g transform="matrix(8.79 0 0 9.18 542.32 469.55)" id="ec544009-daba-40e8-b526-94c20ef1c372">
              <rect
                ...
                vector-effect="non-scaling-stroke" x="-33.085" y="-33.085" rx="0" ry="0" width="66.17"
                height="66.17" />
            </g>
            <g transform="matrix(0 0 0 0 0 0)">
              <g style="">
