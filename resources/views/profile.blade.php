<x-layout-container>
  <section class="px-4 pt-20 pb-6 mx-auto mb-10 max-w-screen-2xl sm:px-6 lg:px-8">
    <div class="flex justify-between mt-14 gap-x-6">
      <div class="w-full max-w-xs space-y-2 font-semibold">
      ...
      <div class="w-full max-w-sm">
        <div class="p-5 border bg-frost-white shadow-Shadow/Shadow 3 rounded-[8px] border-slate-300">
          <img src="{{ asset('img/aziiz_image.png') }}" alt="profile"
            class="rounded-[8px] border border-slate-300 w-full h-[296px] object-cover">
          <x-button size="lg" color="secondary" type="button" class="w-full mt-6">Pilih
            foto</x-button>
          <p class="mt-6 text-lg font-normal text-slate-600">Besar file: maksimum 10 Megabytes. Ekstensi file yang
