<ul class="h-full space-y-2" x-data="{ isOpen: false }">
    ...
    <li @click="isOpen = !isOpen">
        <a href="#"
            ...
            <span class="text-left ms-3 rtl:text-right whitespace-nowrap">Properti</span>
