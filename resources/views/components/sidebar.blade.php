<aside
  class="fixed top-0 z-20 flex flex-col flex-shrink-0 h-full min-h-screen pb-4 transition-all duration-300 md:left-0 lg:opacity-100"
  aria-label="Sidebar">
  <div class="relative flex flex-col flex-1 px-3 py-4 overflow-x-hidden overflow-y-scroll bg-frost-white">
    ...
    <div class="flex flex-col flex-1">
      ...
      @elseif (Request::is('admin/agen/*'))
        <x-agen-sidebar-items></x-agen-sidebar-items>
      @endif
