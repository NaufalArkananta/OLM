{{-- @dd($recomendation_property) --}}
<x-layout-container>
  <div class="px-4 pt-20 pb-6 mx-auto max-w-screen-2xl sm:px-6 lg:px-8">
    <x-home.slider></x-home.slider>
  </div>
  <x-home.search-section></x-home.search-section>
  <div class="px-4 mx-auto max-w-screen-2xl sm:px-6 lg:px-8">
    <x-home.populer-type-section></x-home.populer-type-section>
    <div class="w-full my-10 mt-28">
      <div class="flex justify-between w-full">
        <h4 class="text-2xl font-semibold md:text-3xl lg:text-5xl text-slate-900 text-start">Rekomendasi Properti dari
          Kami
        </h4>
      ...
      <div class="overflow-x-scroll">
        <div class="flex gap-4 my-4 w-max flex-nowrap">
          @foreach ($recomendation_property as $property)
